  ...
  const projects = [
    {
      ...
      resposabilidades: "PO, Front-End & Back-End",
      icon1: iconReact,
      icon2: iconJS,
    ...
    },
    {
      id: 4,
      imgProject: imgProjectTS,
      name: texts.project4title,
      description: texts.project4descri,
      icon1: iconVue,
      icon2: iconTS,
      icon3: iconSpringBoot,
      resposabilidades: "PO & Front-End",
      icon4: iconMySQL,
      githubLink: "https://github.com/VivaTShirt",
    },
    {
      id: 5,
      imgProject: imgProjectTS,
      name: texts.project5title,
      description: texts.project5descri,
      icon1: iconVue,
      icon2: iconTS,
      icon3: iconSpringBoot,
      resposabilidades: "PO & Front-End",
      icon4: iconMySQL,
      githubLink: "https://snack.expo.dev/@smilofc/tafe_correto",
    },
  ];
